...
class ColorThief(object):
    ...
    def get_palette(self, color_count=10, quality=10):
        ...
        cmap = MMCQ.quantize(valid_pixels, color_count, pixel_count)
        return cmap.palette
...
class MMCQ(object):
    ...
    @staticmethod
    def quantize(pixels, max_color, pixel_count):
        """Quantize.
...
class CMap(object):
    ...
    @property
    def palette(self):
        return self.vboxes.map(lambda x: ({'rgb':x['color'],'pixel_percent': 100*x['vbox'].count/self.pixel_count}))
